...
namespace HomeBudgetManagement.API.Core.Infrastructure
{
    public class MediatorModule : Autofac.Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterAssemblyTypes(typeof(CreateMealCommand).GetTypeInfo().Assembly)
            ...
            builder
                .RegisterAssemblyTypes(typeof(CreateMealCommandValidator).GetTypeInfo().Assembly)
